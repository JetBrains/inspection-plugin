...
Current status: beta version 0.3.0 is available. 
...
* Add `classpath 'org.jetbrains.intellij.plugins:inspection-plugin:0.3.0'` to your buildscript dependencies
...
Known bugs / problems at this moment (version 0.3.0):
